...
env = gem.make('Cont-CC-PMSM-v0', motor=motor, load=load, tau=1e-4, visualization=None, constraints=())
...
print()
print(f'Steady-state avg (k >= 300): i_d={np.mean(data_log["i_d"][300:]):.4f}, i_q={np.mean(data_log["i_q"][300:]):.4f}')
...
print(f'CSV geschrieben: export/gem_standard/debug_output.csv')
