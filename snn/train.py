...
The script:
1. Loads PI controller trajectories from pmsm-pem/export/train/
2. Trains the SNN to predict voltage commands from state observations
3. Saves the best model checkpoint to snn/checkpoints/
4. Generates training curves
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train PMSM SNN Controller"
    )
    ...
    parser.add_argument(
        "--beta_output", type=float, default=0.995,
        help="Output layer decay rate"
    )
