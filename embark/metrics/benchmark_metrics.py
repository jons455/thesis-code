...
from embark.utils.config import (
    DEFAULT_EPISODE_DURATION,
    DEFAULT_PMSM,
)
from embark.utils.config import (
    STANDARD_NUM_STEPS as DEFAULT_STANDARD_NUM_STEPS,
)
...
class PMSMParameters:
    ...
    Psi_PM: float = DEFAULT_PMSM.psi_p  # Permanent magnet flux linkage [Vs]
...
class BenchmarkConfig:
    ...
    episode_duration: float = DEFAULT_EPISODE_DURATION  # [s]

    # Control frequency
    control_frequency: float = DEFAULT_PMSM.control_frequency  # [Hz]
...
STANDARD_EPISODE_DURATION = DEFAULT_EPISODE_DURATION  # [s]
STANDARD_NUM_STEPS = DEFAULT_STANDARD_NUM_STEPS
