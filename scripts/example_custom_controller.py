...
import numpy as np
from benchmark.controller_interface import run_benchmark, ControllerInterface
...
def main():
    ...
    print("-" * 60)
    print(f"{'P (Kp=5.0)':<20} {p_results.rmse_iq*1000:>12.2f} {p_results.final_error_iq*1000:>15.2f} {'Yes' if p_results.is_stable else 'No':>8}")
    print(f"{'PI (Kp=5, Ki=1000)':<20} {pi_results.rmse_iq*1000:>12.2f} {pi_results.final_error_iq*1000:>15.2f} {'Yes' if pi_results.is_stable else 'No':>8}")
    print("=" * 60)
